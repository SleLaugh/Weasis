 ...
 * 创建 AttributePreView 的实例，并将其作为偏好设置页面显示 sle
 * 2023年5月23日19:17:17
 */
public class AttributePrefFactory implements PreferencesPageFactory {

  /**
   * 创建 AttributePreView 的实例，并返回它作为 AbstractItemDialogPage，以便将其作为设置页面显示
   * @param properties
   * @return
   */
  @Override
  public AbstractItemDialogPage createInstance(Hashtable<String, Object> properties) {
    return new AttributePreView();
  }
  ...
  public boolean isComponentCreatedByThisFactory(Insertable component) {
    return component instanceof AttributePreView;
  }
