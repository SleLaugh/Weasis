 ...
 * 创建 PresetPreView 的实例，并将其作为偏好设置页面显示 sle
 * 2023年5月16日15:43:11
 */
public class PresetPrefFactory implements PreferencesPageFactory {

  /**
   * 创建 PresetPreView 的实例，并返回它作为 AbstractItemDialogPage，以便将其作为设置页面显示
   * @param properties
   * @return
   */
  @Override
  ...
  public boolean isComponentCreatedByThisFactory(Insertable component) {
    return component instanceof PresetPreView;
  }
